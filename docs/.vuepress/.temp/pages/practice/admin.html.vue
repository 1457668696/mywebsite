<template><div><nav class="table-of-contents"><ul><li><router-link to="#通用组件">通用组件</router-link><ul><li><router-link to="#侧边栏组件">侧边栏组件</router-link></li><li><router-link to="#顶栏组件">顶栏组件</router-link></li></ul></li><li><router-link to="#主体部分">主体部分</router-link><ul><li><router-link to="#登录组件">登录组件</router-link></li><li><router-link to="#主要组件">主要组件</router-link></li><li><router-link to="#用户组件">用户组件</router-link></li><li><router-link to="#展示组件">展示组件</router-link></li></ul></li><li><router-link to="#其他部分">其他部分</router-link><ul><li><router-link to="#封装http请求">封装http请求</router-link></li><li><router-link to="#路由设置">路由设置</router-link></li><li><router-link to="#请求接口">请求接口</router-link></li><li><router-link to="#main-js">main.js</router-link></li></ul></li></ul></nav>
<h1 id="包管理" tabindex="-1"><a class="header-anchor" href="#包管理" aria-hidden="true">#</a> 包管理</h1>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h1 id="main入口" tabindex="-1"><a class="header-anchor" href="#main入口" aria-hidden="true">#</a> Main入口</h1>
<div class="custom-container tip"><p class="custom-container-title">入口文件只做嵌入，顶栏，侧边栏，主体内容。直接copy</p>
<p>明白哪个位置应该放什么组件，包括子组件</p>
</div>
<p>1.采用element-ui的Container布局，顶栏，侧边栏，主体内容确认大布局。
<img src="@source/myappsrc/bigflex.png" alt=""></p>
...
<h3 id="侧边栏组件" tabindex="-1"><a class="header-anchor" href="#侧边栏组件" aria-hidden="true">#</a> 侧边栏组件</h3>
<ul>
<li>一/二级菜单</li>
<li>菜单图标巧用</li>
<li>菜单路由跳转</li>
...
<div class="custom-container tip"><p class="custom-container-title">1.展开和收起的文字不一样，使用模板表达式和三元表达式控制属性</p>
</div>
<div class="language-vue line-numbers-mode" data-ext="vue"><pre v-pre class="language-vue"><code> <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>h3</span><span class="token punctuation">></span></span>{{ isCollapse ? "后台" : "后台管理系统" }}<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>h3</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><div class="custom-container tip"><p class="custom-container-title">2.菜单名字和图标的遍历,用v-for</p>
</div>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token operator">&lt;</span><span class="token operator">!</span><span class="token operator">--</span>一级菜单<span class="token operator">--</span><span class="token operator">></span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="数据" tabindex="-1"><a class="header-anchor" href="#数据" aria-hidden="true">#</a> 数据</h4>
<div class="custom-container tip"><p class="custom-container-title">数据中有嵌套的数据，使用计算属性分离出来，普通菜单和有子菜单。还有控制是否展开的数据，以及路由显示权限的数据</p>
</div>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token literal-property property">computed</span><span class="token operator">:</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
  <span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="方法" tabindex="-1"><a class="header-anchor" href="#方法" aria-hidden="true">#</a> 方法</h4>
<div class="custom-container tip"><p class="custom-container-title">路由已经包含在数据中，通过点击参数传递过来，直接push跳转</p>
<p>但是有个条件，路由不一致才可以跳转或者不在首页/根目录才能跳转</p>
</div>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code>  <span class="token comment">// 点击路由跳转</span>
  <span class="token function">clickMenu</span><span class="token punctuation">(</span><span class="token parameter">item</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
  <span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="顶栏组件" tabindex="-1"><a class="header-anchor" href="#顶栏组件" aria-hidden="true">#</a> 顶栏组件</h3>
<ul>
<li>侧边栏收起按钮</li>
<li>个人中心操作</li>
<li>下拉框退出按钮</li>
</ul>
<h4 id="布局-1" tabindex="-1"><a class="header-anchor" href="#布局-1" aria-hidden="true">#</a> 布局</h4>
<p><img src="@source/myappsrc/header.png" alt=""></p>
<div class="language-css line-numbers-mode" data-ext="css"><pre v-pre class="language-css"><code><span class="token selector">.header-container</span> <span class="token punctuation">{</span>
  <span class="token property">display</span><span class="token punctuation">:</span> flex<span class="token punctuation">;</span>
  <span class="token property">justify-content</span><span class="token punctuation">:</span> space-between<span class="token punctuation">;</span>
  <span class="token property">align-items</span><span class="token punctuation">:</span> center<span class="token punctuation">;</span>
  <span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="数据-1" tabindex="-1"><a class="header-anchor" href="#数据-1" aria-hidden="true">#</a> 数据</h4>
<ul>
<li>无</li>
</ul>
<h4 id="方法-1" tabindex="-1"><a class="header-anchor" href="#方法-1" aria-hidden="true">#</a> 方法</h4>
<div class="custom-container tip"><p class="custom-container-title">绑定按钮事件，点击按钮的时候，收起侧边栏</p>
<p>方法内直接改变属性就可以，不过这里用的是vuex提交方法。</p>
</div>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token operator">&lt;</span><span class="token operator">!</span><span class="token operator">--</span>    左边内容<span class="token operator">--</span><span class="token operator">></span>
   ...
   <span class="token function">handleMenu</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="custom-container tip"><p class="custom-container-title">绑定按钮事件，点击下拉按钮的时候，退出登录</p>
<p>注意这里比较特殊，是绑定在顶级DOM上的，而下拉项传入command参数绑定时间，类似事件委托。</p>
</div>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code>  <span class="token operator">&lt;</span><span class="token operator">!</span><span class="token operator">--</span>    右边内容<span class="token operator">--</span><span class="token operator">></span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="主体部分" tabindex="-1"><a class="header-anchor" href="#主体部分" aria-hidden="true">#</a> 主体部分</h2>
<h3 id="登录组件" tabindex="-1"><a class="header-anchor" href="#登录组件" aria-hidden="true">#</a> 登录组件</h3>
<ul>
<li>表单校验</li>
<li>登录逻辑</li>
</ul>
<h4 id="布局-2" tabindex="-1"><a class="header-anchor" href="#布局-2" aria-hidden="true">#</a> 布局</h4>
<div class="custom-container tip"><p class="custom-container-title">TIP</p>
</div>
<div class="language-vue line-numbers-mode" data-ext="vue"><pre v-pre class="language-vue"><code>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h4 id="数据-2" tabindex="-1"><a class="header-anchor" href="#数据-2" aria-hidden="true">#</a> 数据</h4>
<div class="custom-container tip"><p class="custom-container-title">TIP</p>
</div>
<div class="language-vue line-numbers-mode" data-ext="vue"><pre v-pre class="language-vue"><code>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h4 id="方法-2" tabindex="-1"><a class="header-anchor" href="#方法-2" aria-hidden="true">#</a> 方法</h4>
<div class="custom-container tip"><p class="custom-container-title">TIP</p>
</div>
<div class="language-vue line-numbers-mode" data-ext="vue"><pre v-pre class="language-vue"><code>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="主要组件" tabindex="-1"><a class="header-anchor" href="#主要组件" aria-hidden="true">#</a> 主要组件</h3>
<ul>
<li>用户卡片显示登录信息</li>
<li>表格展示数据</li>
<li>小卡片显示详细</li>
<li>echarts折线图。饼图。柱状图</li>
</ul>
<h4 id="布局-3" tabindex="-1"><a class="header-anchor" href="#布局-3" aria-hidden="true">#</a> 布局</h4>
<div class="custom-container tip"><p class="custom-container-title">TIP</p>
</div>
<div class="language-vue line-numbers-mode" data-ext="vue"><pre v-pre class="language-vue"><code>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h4 id="数据-3" tabindex="-1"><a class="header-anchor" href="#数据-3" aria-hidden="true">#</a> 数据</h4>
<div class="custom-container tip"><p class="custom-container-title">TIP</p>
</div>
<div class="language-vue line-numbers-mode" data-ext="vue"><pre v-pre class="language-vue"><code>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h4 id="方法-3" tabindex="-1"><a class="header-anchor" href="#方法-3" aria-hidden="true">#</a> 方法</h4>
<div class="custom-container tip"><p class="custom-container-title">TIP</p>
</div>
<div class="language-vue line-numbers-mode" data-ext="vue"><pre v-pre class="language-vue"><code>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="用户组件" tabindex="-1"><a class="header-anchor" href="#用户组件" aria-hidden="true">#</a> 用户组件</h3>
<ul>
<li>新增用户</li>
<li>删除用户</li>
<li>编辑用户</li>
...
<h4 id="布局-4" tabindex="-1"><a class="header-anchor" href="#布局-4" aria-hidden="true">#</a> 布局</h4>
<div class="custom-container tip"><p class="custom-container-title">TIP</p>
</div>
<div class="language-vue line-numbers-mode" data-ext="vue"><pre v-pre class="language-vue"><code>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h4 id="数据-4" tabindex="-1"><a class="header-anchor" href="#数据-4" aria-hidden="true">#</a> 数据</h4>
<div class="custom-container tip"><p class="custom-container-title">TIP</p>
</div>
<div class="language-vue line-numbers-mode" data-ext="vue"><pre v-pre class="language-vue"><code>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h4 id="方法-4" tabindex="-1"><a class="header-anchor" href="#方法-4" aria-hidden="true">#</a> 方法</h4>
<div class="custom-container tip"><p class="custom-container-title">TIP</p>
</div>
<div class="language-vue line-numbers-mode" data-ext="vue"><pre v-pre class="language-vue"><code>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="展示组件" tabindex="-1"><a class="header-anchor" href="#展示组件" aria-hidden="true">#</a> 展示组件</h3>
<ul>
<li>接口使用</li>
<li>停止按钮</li>
</ul>
<h4 id="布局-5" tabindex="-1"><a class="header-anchor" href="#布局-5" aria-hidden="true">#</a> 布局</h4>
<div class="custom-container tip"><p class="custom-container-title">曾考虑用表格和普通的插值表达式，感觉差不多。</p>
</div>
<div class="language-vue line-numbers-mode" data-ext="vue"><pre v-pre class="language-vue"><code>  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>h1</span><span class="token punctuation">></span></span>  {{name}}:{{level}}<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>h1</span><span class="token punctuation">></span></span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="数据-5" tabindex="-1"><a class="header-anchor" href="#数据-5" aria-hidden="true">#</a> 数据</h4>
<div class="custom-container tip"><p class="custom-container-title">定义一个空数据容器</p>
</div>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code> <span class="token function">data</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
  <span class="token punctuation">}</span><span class="token punctuation">,</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="方法-5" tabindex="-1"><a class="header-anchor" href="#方法-5" aria-hidden="true">#</a> 方法</h4>
<div class="custom-container tip"><p class="custom-container-title">从接口获取数据，赋值解构给空数据</p>
</div>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="其他部分" tabindex="-1"><a class="header-anchor" href="#其他部分" aria-hidden="true">#</a> 其他部分</h2>
<h3 id="封装http请求" tabindex="-1"><a class="header-anchor" href="#封装http请求" aria-hidden="true">#</a> 封装http请求</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="路由设置" tabindex="-1"><a class="header-anchor" href="#路由设置" aria-hidden="true">#</a> 路由设置</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="请求接口" tabindex="-1"><a class="header-anchor" href="#请求接口" aria-hidden="true">#</a> 请求接口</h3>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">import</span> http <span class="token keyword">from</span> <span class="token string">'../utils/request'</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="main-js" tabindex="-1"><a class="header-anchor" href="#main-js" aria-hidden="true">#</a> main.js</h3>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">import</span> Vue <span class="token keyword">from</span> <span class="token string">'vue'</span>
