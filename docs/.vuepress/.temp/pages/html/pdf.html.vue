<template><div><h2 id="保存pdf缺失" tabindex="-1"><a class="header-anchor" href="#保存pdf缺失" aria-hidden="true">#</a> 保存pdf缺失</h2>
<div class="custom-container tip"><p class="custom-container-title">现在博客都是使用的vue,导航栏的侧边栏都是默认显示的，如果保存成pdf第二页就会显示不完整。需要使用dom删除或者隐藏。</p>
</div>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">//注意，如果属性有空格，就替换成.</span>
