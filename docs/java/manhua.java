public class album {
    ...
    public static void main(String[] args) {
        ...
        Unirest.get("https://www.wnacg.com/albums-index-tag-" + name + ".html")
               .asString();

        //匹配页数
        Matcher matcherPage = Pattern
                             .compile("albums-index-page-(\\d)-tag")
...
for (int i = 1; i <= maxPage; i++) {
    ...
    HttpResponse<String> item =
    Unirest.get("https://www.wnacg.com/albums-index-page-"
                        + page + "-tag-" + name + ".html")
           .asString();
    ...
    for (String s : aid) {
        ...
        Matcher matcherUrl =
        Pattern.compile("<a class=\"down_btn ads\" href=\"//(.+話|[完结])\">")
               .matcher(home1.getBody());
